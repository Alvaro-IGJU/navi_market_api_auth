...
class InteractionCompanyUserPositionsView(APIView):
    """
    Devuelve las posiciones de los usuarios que han interactuado
    ...
    def get(self, request, company_id):
        try:
            ...
            # Contar posiciones de los usuarios
            users_with_positions = User.objects.filter(id__in=user_ids).exclude(position__title__isnull=True)
            print("USERS WITH POSITIONS:")
